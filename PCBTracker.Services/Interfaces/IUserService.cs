...
namespace PCBTracker.Services.Interfaces
{
    ...
    public interface IUserService
    {
        ...
        void CreateUser(int EmployeeID, string username, string password, string firstName, string lastName, bool admin, bool scan, bool extract, bool edit, bool coordinator);


        void UpdateUserPermissions(int employeeID, string username, bool admin, bool scan, bool extract, bool edit, bool coordinator);
